...
public class HashUtils {
    ...
    /**
     * @param clearText String value of text to be encoded in base64
     * @return String value of encoded text provided
     */
    ...
    /**
     * @param hash String value of encoded base64 text
     * @return String value of decoded base64 text provided
     */
    ...
    /**
     * @param base Base String to be hashed to SHA256 string
     * @return Hashed SHA256 base String
     */
    ...
    public static String bcryptHash(String stringToBeHashed, int numberOfRounds) {
        return BCrypt.hashpw(stringToBeHashed, BCrypt.gensalt(numberOfRounds));
    }

    public static boolean bcryptMatch(String plainText, String hash) {
