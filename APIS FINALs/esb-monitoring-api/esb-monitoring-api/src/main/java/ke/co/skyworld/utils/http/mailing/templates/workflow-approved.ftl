...
<@l.layout>
    <p style="font-family: 'Noto Sans', sans-serif; font-size:14px; line-height: 22px; font-weight:500; text-align: left; color:#464646;">
        ...
        Hello,
        <br/><br/>
        Workflow <b>${model.workflow_title}</b> has been <b>${model.approval_status}</b> by <b>${model.actor_full_name}</b>.
        <br/>
        The current workflow status is <b>${model.workflow_status}</b> and is at <b>Approval
            Level ${model.current_workflow_level} of ${model.max_workflow_levels}</b>
    ...
    <p style="padding-top: 10px; font-family: 'Noto Sans', sans-serif; font-size:14px; line-height: 22px; font-weight:500; text-align: left; color:#464646;">
        Go to <a href="${model.portal_workflow_link}">${model.workflow_title} Workflow</a>
    </p>
    <p style="padding-top: 10px; font-family: 'Noto Sans', sans-serif; font-size:14px; line-height: 22px; font-weight:500; text-align: left; color:#464646;">
