...
public class WorkflowApprovedModel {

    private String workflow_id = "";
    private String title = "";
    private String full_name = "";
    private String actor_full_name = "";
    ...
    private int current_workflow_level = 0;
    private int next_workflow_level = 0;
    private int max_workflow_levels = 0;
    private String portal_workflow_link = "";
    private FlexicoreArrayList logs = new FlexicoreArrayList();

    public WorkflowApprovedModel(PortalTypes portal) {
    ...
    public String getActor_full_name() {
        return actor_full_name;
    }

    public void setActor_full_name(String actor_full_name) {
        this.actor_full_name = actor_full_name;
    }
