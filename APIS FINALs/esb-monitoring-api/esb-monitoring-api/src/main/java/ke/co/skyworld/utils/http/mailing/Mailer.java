...
public class Mailer {
	...
	public void setFromName(String theFromName){strFromName = theFromName;}
	...
	public String getFromName(){return strFromName;}
	...
	public boolean doSendMail(String strEmailSubject, String strEmailBodyMessage)  {
		...
		//props.setProperty("mail.smtp.socketFactory.port", String.valueOf(getEmailSMTPPort()));
		...
		props.put("mail.smtp.ssl.enable", getEmailSMTPStartTLSEnable());
		props.put("mail.smtp.host", getEmailSMTPHost());
		props.put("mail.smtp.port", getEmailSMTPPort());
		//props.setProperty("mail.smtp.socketFactory.class", "javax.net.ssl.SSLSocketFactory");
		//props.setProperty("mail.smtp.socketFactory.fallback", "false");
...
//	        System.out.println("Set From: header field of the header - " + getFromEmailAddress());
			...
			{
	        	message.setFrom(new InternetAddress(getFromEmailAddress(), getFromName()));
			}
