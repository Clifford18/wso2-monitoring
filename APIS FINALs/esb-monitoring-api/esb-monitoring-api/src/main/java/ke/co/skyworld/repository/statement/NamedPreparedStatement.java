package ke.co.skyworld.repository.statement;
...
public class NamedPreparedStatement extends PreparedStatementImpl {
    ...
    public static NamedPreparedStatement prepareStatement(ExtendedConnection conn, String sql) throws SQLException {
        //conn.makeBusy();
    ...
    public static NamedPreparedStatement prepareStatement(ExtendedConnection conn, String sql, int var1) throws SQLException {
        //conn.makeBusy();
        Object[] parameters = getNamedPreparedStatementParameters(sql);
        return new NamedPreparedStatement(conn.prepareStatement(String.valueOf(parameters[0]), var1), sql, (List<String>) parameters[1]);
    }

    public static NamedPreparedStatement prepareStatement(ExtendedConnection conn, String sql, int var1, int var2) throws SQLException {
        //conn.makeBusy();
        Object[] parameters = getNamedPreparedStatementParameters(sql);
    ...
    public static NamedPreparedStatement prepareStatement(ExtendedConnection conn, String sql, int var1, int var2, int var3) throws SQLException {
        //conn.makeBusy();
        Object[] parameters = getNamedPreparedStatementParameters(sql);
    ...
    public static NamedPreparedStatement prepareStatement(ExtendedConnection conn, String sql, int[] var) throws SQLException {
        //conn.makeBusy();
        Object[] parameters = getNamedPreparedStatementParameters(sql);
    ...
    public static NamedPreparedStatement prepareStatement(ExtendedConnection conn, String sql, String[] var) throws SQLException {
        //conn.makeBusy();
        Object[] parameters = getNamedPreparedStatementParameters(sql);
        return new NamedPreparedStatement(conn.prepareStatement(String.valueOf(parameters[0]), var)
                , sql, (List<String>) parameters[1]);
